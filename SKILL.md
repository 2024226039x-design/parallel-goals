---
name: parallel-goals
description: Convert a user's task into a filled brief, a concrete top-level goal, independent parallel agent goals, and a synthesized result. Use when the user asks for parallel goals, parallel agents, or to fill a build-task brief.
---
